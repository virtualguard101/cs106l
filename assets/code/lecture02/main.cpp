 ...
 * @return A pair. The first element (bool) indicates if the equation has a
 * solution. The second element is a pair of the roots if they exist.
 */
...
int main() {
  ...
  if (result.first) {
    ...
    std::cout << "Solutions: " << solutions.first << ", " << solutions.second
              << std::endl;
  } else {
