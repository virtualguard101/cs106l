...
const std::map<std::string, int> roman{{"I", 1},   {"V", 5},   {"X", 10},
                                       {"L", 50},  {"C", 100}, {"D", 500},
                                       {"M", 1000}};

// Structured Binding
std::tuple<std::string, std::string, int, int, double> getAlbum(std::string t,
                                                                std::string a,
                                                                int y, int tr,
                                                                double p) {
  std::string title = t;
...
int main() {
  ...
  // int temp2 = {TempReading}; // This will cause a compile error: narrowing
  // conversion!!!
  ...
  // Structured Binding
  auto [title, artist, year, tracks, price] =
      getAlbum("The Dark Side of the Moon", "Pink Floyd", 1973, 0, 0.99);
