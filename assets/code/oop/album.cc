...
Album::Album(std::string title, std::string artist,
int year, int tracks,
double price) : title(title), artist(artist), year(year), tracks(tracks), price(price), music_count(tracks) {}
